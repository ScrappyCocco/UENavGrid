...
public:
	...
	*/
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Components")
	TObjectPtr<UCapsuleComponent> MovementCollisionCapsule;
	/* Shown when the pawn is selected/has its turn */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Components")
	TObjectPtr<UStaticMeshComponent> SelectedHighlight;
	...
	UFUNCTION(BlueprintCallable)
	UNavTileComponent* GetTile() const;
...
protected:
	...
	UPROPERTY(Transient)
	TObjectPtr<ANavGrid> PreviewGrid;
